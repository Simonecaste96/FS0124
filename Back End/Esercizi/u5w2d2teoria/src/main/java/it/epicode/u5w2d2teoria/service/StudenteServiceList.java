...
public class StudenteServiceList {
    ...
    //Optional è un wrapper, invece di resittuire null
    public Optional<Studente> getStudenteByMatricola(int matricola) {
        return studenti.stream().filter(e -> e.getMatricola() == matricola).findFirst();
    }
    ...
    public String saveStudente(Studente studente) {
        ...
        return "Studente aggiunto alla lista con matricola: " + studente.toString();
    }


    public Studente updateStudente(int matricola, StudenteDto studenteUpd) throws StudenteNonTrovatoException {
