...
public class AulaService {
    ...
    public String saveAula(AulaDto aulaDto){
        ...
        return "Aula con id: "+aula.getId()+" aggiunta correttamente";
    }
    ...
    public Aula updateAula(int id, Aula aulaDto) throws AulaNonTrovataException {
    ...
    public String deleteAula(int id){
        ...
        if(aulaOptional.isPresent()){
            ...
            throw  new AulaNonTrovataException("Aula con id: "+ id + " non esiste");
        }
    }
}
